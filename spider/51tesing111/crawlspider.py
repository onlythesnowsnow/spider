...
def get_page(viewHref, grade, number):
    ...
    try:
        response0 = requests.get(viewHref, timeout=70, headers = headers).content
 ...
 #       print lines
	...
	now_page = 1
	    ...
	    print next_page_href
            ...
            try:
                response3 = requests.get(next_page_href, cookies=cookie, timeout=70,  headers=headers).content
            except:
		floor = 0
                return 1
